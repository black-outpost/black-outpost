...
function generateIdentifier(firstName, lastName) {
  ...
  const ls = extractSyllables(lastName)
...
export default function CharacterCreate() {
  const { identifier: adminId } = useAuth()
  ...
  function handleGenerate() {
    if (!form.firstName || !form.lastName) {
      setErrors(e => ({ ...e, identifier: 'Enter first and last name first' }))
      return
    }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const statsDefault = { strength:0, vitality:0, speed:0, defense:0, reiatsu:0, reiryoku:0, bujutsu:0, bukijutsu:0, tamashi:0, nazo:0 }
      ...
      await setDoc(doc(db, 'characters', characterId), {
        ...
        height: null, weight: null, appearance: '', personality: '', history: '',
        stats: statsDefault,
